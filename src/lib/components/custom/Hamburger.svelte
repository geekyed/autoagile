...
<DropdownMenu.Root>
  ...
  <DropdownMenu.Content class='w-72 top-10px'>
    <DropdownMenu.Group>
      <DropdownMenu.Item>
        <Button variant='ghost' class='flex flex-row w-full justify-start text-lg' href='/'><BatteryCharging class="mr-2 size-6"/> 
          Charge
        </Button>
      </DropdownMenu.Item>
      <DropdownMenu.Item><Button variant='ghost' class='flex flex-row w-full justify-start text-lg' href='profile'><User class="mr-2 size-6"/> Profile</Button></DropdownMenu.Item>
      <DropdownMenu.Item><Button variant='ghost' class='flex flex-row w-full justify-start text-lg'  href='car-charging'><Settings class="mr-2 size-6"/> Car Config</Button></DropdownMenu.Item>
    ...
    {:else}
      <DropdownMenu.Item>
        <Button variant='ghost' class='flex flex-row w-full justify-start text-lg' href="/auth/logout"><LogOut class="mr-2 size-6"/> Logout</Button>
      </DropdownMenu.Item>
    {/if}
    </DropdownMenu.Group>
